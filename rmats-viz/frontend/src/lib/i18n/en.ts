...
export const en = {
  ...
  analysisDetail: {
    ...
    pdfModal: {
      ...
      sections: {
        a: "A. Global Analysis Summary",
        aDesc: "Summary statistics, distribution figures, and splice-site sequence logos for all events",
        b: "B. Significant Events Summary",
        bDesc: "Statistics and figures restricted to significant events (FDR/PSI thresholds)",
        c: "C. Significant vs Non-Significant Comparison",
        cDesc: "Feature comparison table and logos between significant and non-significant groups",
        d: "D. Permutation Test",
        dDesc: "Empirical significance of the observed PSI score distribution (500 iterations)",
        e: "E. hnRNP Motif Enrichment",
        eDesc: "rMAPS2-inspired hnRNP RNA-binding protein motif enrichment analysis with heatmap",
        f: "F. Enrichr Pathway Enrichment",
        fDesc: "Gene-set enrichment against KEGG, GO, Reactome, and WikiPathways libraries",
        topEvents: "Top Splicing Events Table",
        topEventsDesc: "Top 20 significant SE events ranked by FDR and |PSI|",
      },
