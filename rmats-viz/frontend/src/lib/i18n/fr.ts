...
export const fr: Translations = {
  ...
  top10Page: {
    title: "Top 10 événements",
    sortedBy: "— classés par FDR puis |ΔPSI|",
    viewAllEvents: "Voir tous les événements",
    group1Default: "Groupe 1",
    group2Default: "Groupe 2",
  },
  top10View: {
    noEvents: "Aucun événement top-10 trouvé.",
    modeLabels: {
  ...
  deepAnalysis: {
    ...
    loading: "Chargement des événements…",
    noEvents:
      "Aucun événement à afficher. Ajoutez des événements au panier ou vérifiez que l'analyse a des données.",
